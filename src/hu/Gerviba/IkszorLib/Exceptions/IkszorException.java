 ...
 * @author Gerviba
 */
public class IkszorException extends Exception {

	private static final long serialVersionUID = 6273104262188399913L;

	public IkszorException(String s, Throwable t) {
    	super(s, t);
    }
